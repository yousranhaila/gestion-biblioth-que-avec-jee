...
<div class="container-fluid">
  ...
  <jsp:include page="\ASSETS\adminsidebar.jsp"></jsp:include>    
     ...
     <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-4">
      ...
      <form class='align-items-end row row-cols-sm-auto row-cols-md-auto row-cols-lg-auto g-3  mb-4 d-flex '   >
			  ...
			  <div class="col-12 ">
			    <div class="input-group">
			      ...
			      <div class="col-3"><button type="button" data-bs-toggle="modal" data-bs-target="#exampleModalajouterlivre" class="btn btn-dark btn-sm ms-4">Ajouter</button></div>
