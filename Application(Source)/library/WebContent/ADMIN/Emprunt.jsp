...
<div class="container-fluid">
  ...
  <jsp:include page="\ASSETS\adminsidebar.jsp"></jsp:include>    
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-4">
      ...
      <div class="alert alert-danger" role="alert"> Cette emprunt n'existe pas !</div>
      <%} %>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover table-sm">
          ...
          <sql:query dataSource="${db}" var="rs">  
			SELECT e.id, e.isbn ,e.appoge, l.Titre, e.date_debut, e.date_fin from emprunt e , livre l where e.isbn=l.isbn;  
			</sql:query>
          <tbody>
